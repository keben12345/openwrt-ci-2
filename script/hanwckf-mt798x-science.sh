...
sed -i 's/ImmortalWrt/MT3000/g' package/base-files/files/bin/config_generate
sed -i "s/ImmortalWrt/MT3000/g" package/mtk/applications/mtwifi-cfg/files/mtwifi.sh
