...
sed -i '$a src/gz ddnsgo https://github.com/sirpdboy/luci-app-ddns-go.git^aebe633d73045665253e03de5bf7a160f9133e3b' feeds.conf.default
./scripts/feeds update -p ddnsgo
./scripts/feeds install -p ddnsgo
